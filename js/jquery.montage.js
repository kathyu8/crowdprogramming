...
(function( window, $, undefined ) {
	...
	*/
	...
	$.Montage.defaults 			= {
		...
		maxh					: 200,	// the maximum height that a picture should have.
		...
		fixedHeight				: 200,	// if the value is set this has priority over defaults.minsize. All images will have this height.
		minsize					: true,// minw,minh are irrelevant. Chosen height is the minimum one available.
